...
If you want to add a folder to your list of managed directories, you can just drag cfs_watcher.py into that folder and run it. If you do this, it will create a zipper.ignore file in the directory. This is a regular text file you can use to list any files or directories that shouldn't be uploaded. As an alternative to cfs_watcher, you can manually add the system path of a directory you want to manage to a 'managed.txt' file in CFS_Manager's installed directory.
